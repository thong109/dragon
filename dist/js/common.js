...
function isFullScreenMode() {
  ...
  return (
    1 == n && document.documentElement.classList.add('fullsreen-support'),
    n
  );
}
function toggleFullScreen() {
    ...
    getSize() {
      if (
        ...
        ((n = Utils.clamp(0, n, 1)),
          (this.goX = Math.round(
            n *
              (this.Parent.offsetHeight + (innerWidth + i[0].offsetWidth / 2)),
          )));
      }
    }
    upDate(t) {
  ...
  class e {
    advance(t) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = Utils.damp(this.value, this.to, 60 * this.lerp, t)),
  ...
  class i {
    ...
    setSize = () => {
      ...
      if (
        ...
        ((t = this.main.offsetHeight), (this.main.style.height = t + 'px'));
    };
    resize = () => {
  ...
  return class {
    ...
    postBar() {
      if (
        ...
        const t = Math.round(
          this.progress *
            (this.options.content.offsetHeight - this.thumbHeight),
        );
...
if (
  ...
  ((Clone = FaciSlide.cloneNode(!0)).classList.replace(
    'faci-slide',
    'bg-slide',
  ),
  ...
  if (
    ...
    subItems &&
      Array.from(subItems, function (e) {
        ...
        (e.style.setProperty('--data-height', t + 'px'),
          e.classList.add('off'));
      }),
      ...
      (faciPlan.forEach(function (i) {
        ...
        if (
          ...
          ((c.style.transform =
            ...
            (c.style.top = i.offsetHeight / 2 - 700 + 'px'),
            (c.style.left = window.innerWidth / 2 - 1155 + 'px'),
            u && !i.querySelector('.faci-note') && i.append(u));
      }),
      masterPlan)
    ) {
...
if (scrollStay) {
  ...
  function applySlide() {
    ...
    if (
      ...
      (changeUrl(
        boxLi[groupIndex].querySelector('button').dataset.href,
        boxLi[groupIndex].querySelector('button').dataset.title,
        boxLi[groupIndex].querySelector('button').dataset.description,
        boxLi[groupIndex].querySelector('button').dataset.keyword,
        boxLi[groupIndex].querySelector('button').dataset.name,
      ),
        changeAlternate(
          boxLi[groupIndex].querySelector('button').dataset.href,
          boxLi[groupIndex].querySelector('button'),
          1,
        ));
    }
    ...
    if (groupCentral[groupIndex].classList.contains('show-text')) {
      ...
      (Tagline &&
        (groupCentral[groupIndex].querySelector('.tagline-big')
    ...
    (groupCentral[groupIndex].classList.contains('home-intro', 'show-text') &&
      rightHeader.classList.add('white'),
      ...
      groupCentral[groupIndex].classList.contains('home-video', 'show-text') &&
        (Header.classList.add('light'),
        (ytVideo || boxVideo) &&
      ...
      groupCentral[groupIndex].classList.contains(
        ...
        (rightHeader.classList.add('white'),
        PanZoom && (panzoom.reset(), goOut.click())),
      groupCentral[groupIndex].classList.contains(
        'picture-library',
        'show-text',
      ) && (Header.classList.add('light'), rightHeader.classList.add('white')),
      ...
      groupCentral[groupIndex].classList.contains(
        'home-facilities',
        'show-text',
      ) && (Footer.classList.add('hide'), Header.classList.add('light')),
      groupCentral[groupIndex].classList.contains('facilities', 'show-text') &&
        rightHeader.classList.add('white'),
      groupCentral[groupIndex].classList.contains('masterplan', 'show-text') &&
        rightHeader.classList.add('white'),
      groupCentral[groupIndex].classList.contains('block', 'show-text') &&
        rightHeader.classList.add('white'),
      groupCentral[groupIndex].classList.contains(
        'home-partner',
        'show-text',
